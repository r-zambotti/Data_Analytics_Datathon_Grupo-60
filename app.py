...
if page == page_0:
    ...
    # descrição
    st.markdown('''
                Analisando impacto causado pelas ações voluntárias da ONG Passos Mágicos, desenvolvendo uma análise analítica, gerando insight e dashboard interativos.<br> 
    ...
    # contexto missão, programas e impactos
    ...
    with tab1:
        st.markdown('''
                    <p style="font-size: 18px">
                    A missão da Passos Mágicos é transformar a vida de jovens e crianças, fornecendo ferramentas que os levem a melhores oportunidades de vida. 
                    A visão da organização é viver em um Brasil onde todas as crianças e jovens tenham iguais oportunidades para realizar seus sonhos e se tornem agentes transformadores de suas próprias vidas.
                    </p>
                    ''', unsafe_allow_html=True)
